...
int test(int argc, char const *argv[])
{
    ...
    malloc((void **)&h_a, sizeof(int) * m * n);
    malloc((void **)&h_b, sizeof(int) * n * k);
    malloc((void **)&h_c, sizeof(int) * m * k);
    malloc((void **)&h_cc, sizeof(int) * m * k);
    ...
    printf("Time elapsed on matrix multiplication of %dx%d . %dx%d on GPU: %f ms.\n\n", m, n, n, k, (gpu_elapsed_time_ms / NUM_ITERATIONS));
    ...
    printf("Time elapsed on matrix multiplication of %dx%d . %dx%d on CPU: %f ms.\n\n", m, n, n, k, (cpu_elapsed_time_ms / NUM_ITERATIONS));
